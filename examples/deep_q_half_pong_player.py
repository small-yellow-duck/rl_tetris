...
if __name__ == '__main__':
    ...
    # playback_mode="True"
    player = DeepQHalfPongPlayer(checkpoint_path='deep_q_half_pong_networks', playback_mode=False)
    #player = DeepQHalfPongPlayer(checkpoint_path='deep_q_half_pong_networks_40x40_8', playback_mode=True)
    player.start()
